 ...
 * @param urls []
 */
function loadFilesToFolder(destFolder, urls, singleFolder) {
            ...
            .on('response', function(response) {
                if (response.statusCode !== 200) {
                    ...
                    if (singleFolder === true) {
                        ...
                        response.pipe(fs.createWriteStream(destFolder + removeExtension(fileName) + '/' + fileName));
                    } else {
        ...
        config.forEach(function (obj) {
            ...
            mkdirp(rootFolder + destFolder, function () {
                if (obj.hasOwnProperty('singleFolder') && obj.singleFolder) {
                    loadFilesToFolder(rootFolder + destFolder, obj.urls, true);
                } else {
